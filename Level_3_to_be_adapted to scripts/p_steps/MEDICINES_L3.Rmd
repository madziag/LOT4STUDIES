...
if(!is.null(tab15)){
tab15_graph<-tab15[count_medicines=="<5", count_medicines:= 0.9]
...
if (tab15_graph[count_medicines !=0.9,.N] != 0){
ggplotly(ggplot(tab15_graph[count_medicines !=0.9], aes(x = year, y = medicines_per_1000_py, group=truncated_atc_code)) +
...
The incidence rate cannot be shown since the counts of medicine exposure are masked and replaced with 0.9 for visualization purpose.
...
ggplotly(ggplot(tab15_graph[count_medicines ==0.9], aes(x = year, y = medicines_per_1000_py, group=truncated_atc_code)) +
                           geom_line(aes(color=truncated_atc_code)) +
                           geom_point(aes(color=truncated_atc_code)) + 
                               ggtitle("Rate of medicine exposure in females of childbearing age(counts smaller than 5") + 
                               xlab("Year") +
                               ylab("Rate per 1000 person-years")+
                             theme_classic() +
                             guides(shape = guide_legend(override.aes = list(size = 0.3))) +
...
if(!is.null(tab16)){
tab16_graph<-tab16[count_medicines=="<5", count_medicines:= 0.9]
...
if (tab16_graph[count_medicines !=0.9,.N] != 0){
fig.tab16_med<-vector(mode="list", length=length(unique(tab16_graph[count_medicines!=0.9][,age_band])))
for(i in 1:length(unique(tab16_graph[count_medicines !=0.9][,age_band]))){
fig.tab16_med[[i]]<-ggplotly(ggplot(tab16_graph[count_medicines!=0.9][age_band==unique(tab16_graph[,age_band])[i]], aes(x = year, y = medicines_per_1000_py, group=truncated_atc_code)) +
                           geom_line(aes(color=truncated_atc_code)) +
                           geom_point(aes(color=truncated_atc_code)) + 
                               ggtitle(paste0("Rate of medicine exposure in females of childbearing age, age band:", unique(tab16_graph[count_medicines !=0.9][,age_band])[i])) + 
                               xlab("Year") +
                               ylab("Rate per 1000 person-years")+
                             theme_classic() +
                             guides(shape = guide_legend(override.aes = list(size = 0.3))) +
...
if(!is.null(tab16_graph)){
if (tab16_graph[count_medicines ==0.9,.N] != 0){
fig.tab16_med_small<-vector(mode="list", length=length(unique(tab16_graph[count_medicines==0.9][,age_band])))
for(i in 1:length(unique(tab16_graph[count_medicines ==0.9][,age_band]))){
fig.tab16_med_small[[i]]<-ggplotly(ggplot(tab16_graph[count_medicines==0.9][age_band==unique(tab16_graph[,age_band])[i]], aes(x = year, y = medicines_per_1000_py, group=truncated_atc_code)) +
                           geom_line(aes(color=truncated_atc_code)) +
                           geom_point(aes(color=truncated_atc_code)) + 
                               ggtitle(paste0("Rate of medicine exposure in females of childbearing age, age band:", unique(tab16_graph[count_medicines ==0.9][,age_band])[i],"(counts smaller than 5)")) + 
                               xlab("Year") +
                               ylab("Rate per 1000 person-years")+
                             theme_classic() +
                             guides(shape = guide_legend(override.aes = list(size = 0.3))) +
