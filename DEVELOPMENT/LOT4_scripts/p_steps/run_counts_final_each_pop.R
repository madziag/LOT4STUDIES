...
for (file in list.files(path=paste0(output_dir,my_format,"_files"), pattern="preg_starts_during_tx_episodes", ignore.case = T)){file.copy(paste0(output_dir,my_format,"_files/", file),preg_med_counts_csv_xlsx )}
for (file in list.files(path=paste0(output_dir,"plots"), pattern="preg_starts_during_tx_episodes", ignore.case = T)){file.copy(paste0(output_dir,"plots/",file),preg_med_counts_plots )}
