...
# Testing 
study_pop_meds[study_pop_meds$person_id == "ConCDM_SIM_200421_00331" & study_pop_meds$event_date == "2012-06-05",]$event_date<- as.Date("2010-12-06")
study_pop_meds[study_pop_meds$person_id == "ConCDM_SIM_200421_00925" & study_pop_meds$event_date== "2019-05-08",]$event_date<- as.Date("2013-07-13")
study_pop_meds[study_pop_meds$person_id == "ConCDM_SIM_200421_00247" & study_pop_meds$event_date== "2012-03-12",]$event_date<- as.Date("2014-07-28")
