...
for(i in 1:length(my_data)){
  ...
  pdf((paste0(plot_folder,"/", pop_prefix, "_kaplan_myer_", my_label[2],"_",my_label[1], ".pdf")), width=8, height=4)
  ...
  saveRDS(my_surv,paste0(g_intermediate, pop_prefix, "_kaplan_myer_", my_label[2],"_",my_label[1], "_model_data.rds")) 
}
