...
## if(!require(lubridate)){install.packages("lubridate")} -> already loaded in packages.R
...
#need dates vector
### Denominator is already present in ALL_regions folder - Gets one of the denominator files for the date 
