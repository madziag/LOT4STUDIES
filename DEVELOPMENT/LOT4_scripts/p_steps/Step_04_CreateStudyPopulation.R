...
for(i in 1:nrow(SCHEME_04)){
  ...
  saveRDS(FlowChartSourcetoStudy,file = paste0(std_pop_tmp, gsub("study_population.rds","",SCHEME_04[["file_out"]][i]),"FlowChartSourcetoStudy.rds"))
  saveRDS(FlowChartSourcetoStudy,file = paste0(output_dir, gsub("study_population.rds","",SCHEME_04[["file_out"]][i]),"FlowChartSourcetoStudy.rds"))
} 
