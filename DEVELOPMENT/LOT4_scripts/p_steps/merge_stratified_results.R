...
stratified_dir <- "C:/Users/31653/Desktop/LOT4_Sourcetree/DEVELOPMENT/LOT4_scripts/DENMARK_90"
...
for(i in 1:length(stratified_files)){
  ...
  if(str_detect(stratified_files[i],"reason_adr"))            {setnames(df,"N","N_reason_discontinue_ADR")      ;setnames(df,"rates","Proportion_reason_discontinue_ADR")}
  if(str_detect(stratified_files[i],"reason_pregstart"))      {setnames(df,"N","N_reason_discontinue_pregnancy");setnames(df,"rates","Proportion_reason_discontinue_pregnancy")}
  if(str_detect(stratified_files[i],"reason_pregwish"))       {setnames(df,"N","N_reason_discontinue_pregwish") ;setnames(df,"rates","Proportion_reason_discontinue_pregwish")}
  if(str_detect(stratified_files[i],"reason_multiple"))       {setnames(df,"N","N_reason_discontinue_multiple") ;setnames(df,"rates","Proportion_reason_discontinue_multiple")}
  if(str_detect(stratified_files[i],"reason_unknown"))        {setnames(df,"N","N_reason_discontinue_unknown")  ;setnames(df,"rates","Proportion_reason_discontinue_unknown")}
  # Contraceptives type
  if(str_detect(stratified_files[i],"contracep_progest"))    {setnames(df,"N","N_contraceptive_progest")    ;setnames(df,"rates","Proportion_contraceptive_progest")}
  if(str_detect(stratified_files[i],"contracep_fixedcomb"))  {setnames(df,"N","N_contraceptive_fixedcomb")  ;setnames(df,"rates","Proportion_contraceptive_fixedcomb")}
  if(str_detect(stratified_files[i],"contracep_sequenprep")) {setnames(df,"N","N_contraceptive_sequenprep") ;setnames(df,"rates","Proportion_contraceptive_sequenprep")}
  if(str_detect(stratified_files[i],"contracep_vaginalring")){setnames(df,"N","N_contraceptive_vaginalring");setnames(df,"rates","Proportion_contraceptive_vaginalring")}
  if(str_detect(stratified_files[i],"contracep_patch"))      {setnames(df,"N","N_contraceptive_patch")      ;setnames(df,"rates","Proportion_contraceptive_patch")}
  if(str_detect(stratified_files[i],"contracep_implant"))    {setnames(df,"N","N_contraceptive_implant")    ;setnames(df,"rates","Proportion_contraceptive_implant")}
  if(str_detect(stratified_files[i],"contracep_injection"))  {setnames(df,"N","N_contraceptive_injection")  ;setnames(df,"rates","Proportion_contraceptive_injection")}
  if(str_detect(stratified_files[i],"contracep_IUD"))        {setnames(df,"N","N_contraceptive_IUD")        ;setnames(df,"rates","Proportion_contraceptive_IUD")}
  #Drops columns
...
prev_ret_df<-prev_ret_df[,c("YM","N_overall","Freq_overall","Rate_overall",
                            # "N_age_12_21","Proportion_age_12_21",
                            # "N_age_21_31","Proportion_age_21_31",
                            # "N_age_31_41","Proportion_age_31_41",
                            # "N_age_41_56","Proportion_age_41_56",
                            "N_tx_duration_1_182","Proportion_tx_duration_1_182",
                            "N_tx_duration_182_365","Proportion_tx_duration_182_365",
                            "N_tx_duration_over365","Proportion_tx_duration_over365")]

saveRDS(prev_ret_df,paste0(combined_dir,"Retinoid_Prevalence_stratified_combined_age-tx_dur.rds") )
write.csv(prev_ret_df,paste0(combined_dir,DAP,"_Retinoid_Prevalence_stratified_combined_age-tx_dur.csv"))
...
# write.csv(incidence_ret_df,paste0(combined_dir, DAP,"_Retinoid_Incidence_stratified_combined_age.csv"))
...
disc_ret_df<-disc_ret_df[,c("YM","N_overall","Freq_overall","Rate_overall",
                            ...
                            "N_tx_duration_over365","Proportion_tx_duration_over365"
                            # ,
                            # "N_reason_discontinue_pregwish","Proportion_reason_discontinue_pregwish",
                            # "N_reason_discontinue_pregnancy","Proportion_reason_discontinue_pregnancy",
                            # "N_reason_discontinue_ADR","Proportion_reason_discontinue_ADR", 
                            # "N_reason_discontinue_multiple","Proportion_reason_discontinue_multiple", 
                            # "N_reason_discontinue_unknown","Proportion_reason_discontinue_unknown"
                            )]

# NEEDS correction of rate calculation (divide by 100)
# disc_ret_df[,Proportion_age_12_21:=Proportion_age_12_21/100][,Proportion_age_21_31:=Proportion_age_21_31/100][,Proportion_age_31_41:=Proportion_age_31_41/100][,Proportion_age_41_56:=Proportion_age_41_56/100]
# disc_ret_df[,Proportion_tx_duration_1_182:=Proportion_tx_duration_1_182/100][,Proportion_tx_duration_182_365:=Proportion_tx_duration_182_365/100][,Proportion_tx_duration_over365:=Proportion_tx_duration_over365/100]

saveRDS(disc_ret_df,paste0(combined_dir,"Retinoid_Discontinued_stratified_combined_age-tx_dur-reason.rds") )
write.csv(disc_ret_df,paste0(combined_dir,DAP,"_Retinoid_Discontinued_stratified_combined_age-tx_dur-reason.csv"))
...
# write.csv(switched_ret_df,paste0(combined_dir, DAP,"_Retinoid_Switched_to_Alt_Meds_stratified_combined_age.csv"))
...
# write.csv(contra_prior_ret_df,paste0(combined_dir,DAP, "_Retinoid_Contra_Prior_stratified_combined_age.csv"))
...
med_use_during_contra_ret_df<-med_use_during_contra_ret_df[,c("YM","N_overall","Freq_overall","Rate_overall",
                                                              ...
                                                              # "N_age_31_41","Proportion_age_31_41",
                                                              # "N_age_41_56", "Proportion_age_41_56",
                                                              "N_contraceptive_progest","Proportion_contraceptive_progest",
                                                              "N_contraceptive_fixedcomb","Proportion_contraceptive_fixedcomb",
                                                              "N_contraceptive_sequenprep","Proportion_contraceptive_sequenprep",
                                                              "N_contraceptive_vaginalring","Proportion_contraceptive_vaginalring",
                                                              "N_contraceptive_patch","Proportion_contraceptive_patch",
                                                              "N_contraceptive_implant","Proportion_contraceptive_implant",
                                                              "N_contraceptive_injection","Proportion_contraceptive_injection"
                                                              # ,
                                                              # "N_contraceptive_IUD","Proportion_contraceptive_IUD"
                                                              )]

saveRDS(med_use_during_contra_ret_df,paste0(combined_dir, "Retinoid_Med_Use_During_Contra_Episode_stratified_combined_age_contratype.rds") )
write.csv(med_use_during_contra_ret_df,paste0(combined_dir, DAP,"_Retinoid_Med_Use_During_Contra_Episode_stratified_combined_age_contratype.csv"))
...
prev_valp_df<-prev_valp_df[,c("YM","N_overall","Freq_overall","Rate_overall",
                              ...
                              # "N_age_31_41","Proportion_age_31_41",
                              # "N_age_41_56","Proportion_age_41_56",
                              # "N_indication_bipolar","Proportion_indication_bipolar",
                              # "N_indication_epilepsy","Proportion_indication_epilepsy",
                              # "N_indication_migraine","Proportion_indication_migraine",
                              # "N_indication_multiple","Proportion_indication_multiple",
                              # "N_indication_unknown","Proportion_indication_unknown", 
                              "N_tx_duration_1_182","Proportion_tx_duration_1_182",
                              "N_tx_duration_182_365","Proportion_tx_duration_182_365",
                              "N_tx_duration_over365","Proportion_tx_duration_over365")]
saveRDS(prev_valp_df,paste0(combined_dir,"Valproate_Prevalence_stratified_combined_age-indication-tx_dur.rds") )
write.csv(prev_valp_df,paste0(combined_dir,DAP,"_Valproate_Prevalence_stratified_combined_age-indication-tx_dur.csv"))
...
# write.csv(incidence_valp_df,paste0(combined_dir, DAP,"_Valproate_Incidence_stratified_combined_age-indication.csv"))
...
# NEEDS correction of rate calculation (divide by 100)
# disc_valp_df[,Proportion_age_12_21:=Proportion_age_12_21/100][,Proportion_age_21_31:=Proportion_age_21_31/100][,Proportion_age_31_41:=Proportion_age_31_41/100][,Proportion_age_41_56:=Proportion_age_41_56/100]
# disc_valp_df[,Proportion_tx_duration_1_182:=Proportion_tx_duration_1_182/100][,Proportion_tx_duration_182_365:=Proportion_tx_duration_182_365/100][,Proportion_tx_duration_over365:=Proportion_tx_duration_over365/100]
# disc_valp_df[,Proportion_indication_bipolar:=Proportion_indication_bipolar/100][,Proportion_indication_epilepsy:=Proportion_indication_epilepsy/100][,Proportion_indication_migraine:=Proportion_indication_migraine/100][,Proportion_indication_multiple:=Proportion_indication_multiple/100][,Proportion_indication_unknown:=Proportion_indication_unknown/100]

saveRDS(disc_valp_df,paste0(combined_dir,"Valproate_Discontinued_stratified_combined_age-indication-tx_dur-reason.rds") )
write.csv(disc_valp_df,paste0(combined_dir,DAP,"_Valproate_Discontinued_stratified_combined_age-indication-tx_dur-reason.csv"))
...
# write.csv(switched_valp_df,paste0(combined_dir, DAP,"_Valproate_Switched_to_Alt_Meds_stratified_combined_age-indication.csv"))
...
# write.csv(contra_prior_valp_df,paste0(combined_dir,DAP, "_Valproate_Contra_Prior_stratified_combined_age-indication.csv"))
...
write.csv(med_use_during_contra_valp_df,paste0(combined_dir, DAP,"_Valproate_Med_Use_During_Contra_Episode_stratified_combined_age_indication_contratype.csv"))
