...
if(length(actual_tables$VACCINES)>0){
      ...
      for (a in 1:length(LETTERS)){
        for (b in 1:length(years_this_table)){
          if(df[sex_at_instance_creation=="M" & atc_code_1==LETTERS[a] & year==years_this_table[b],.N]>0){
            ...
            saveRDS(df[sex_at_instance_creation=="M" & atc_code_1==LETTERS[a] & year==years_this_table[b], c("person_id", "year", "meaning", "vx_atc")], paste0(vaccines_pop,subpopulations_names[s], "/", paste0(LETTERS[a], "_", years_this_table[b], "_m_population_", actual_tables$VACCINES[y], ".rds")))
            } else {
              saveRDS(df[sex_at_instance_creation=="M" & atc_code_1==LETTERS[a] & year==years_this_table[b], c("person_id", "year", "meaning", "vx_atc")], paste0(vaccines_pop, paste0(LETTERS[a], "_", years_this_table[b], "_m_population_", actual_tables$VACCINES[y], ".rds")))
          }
  ...
  tab10[is.na(atc_code_1), atc_code_1:="All"]
