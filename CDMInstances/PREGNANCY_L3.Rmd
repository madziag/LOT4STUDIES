...
flowchart<-fread(paste0(preg_dir,subpopulations_names[s], "/Masked/", subpopulations_names[s],"_flowchart_pregnancy_masked.csv"))
datatable(flowchart, options = list(scrollX=T))
}
```
...
datatable(description, options = list(scrollX=T))
  ...
  description<-fread(paste0(preg_dir,subpopulations_names[s], "/Masked/", subpopulations_names[s],"_description_pregnancy_masked.csv"))
datatable(description, options = list(scrollX=T))
}
```
...
graph_1<-fread(paste0(preg_dir,subpopulations_names[s], "/Masked/", subpopulations_names[s],"_graph_1_masked.csv"))
datatable(graph_1, options = list(scrollX=T))
}
```
...
graph_2<-fread(paste0(preg_dir,subpopulations_names[s], "/Masked/", subpopulations_names[s],"_graph_2_masked.csv"))
datatable(graph_2, options = list(scrollX=T))
}
```
...
datatable(tab17, options = list(scrollX=T))
    ...
    tab17<-fread(paste0(preg_dir,subpopulations_names[s], "/Masked/", subpopulations_names[s],"_tab17_pregnancy_masked.csv"))
datatable(tab17, options = list(scrollX=T))
}
```
...
datatable(tab17, options = list(scrollX=T))
    ...
    tab19<-fread(paste0(preg_dir,subpopulations_names[s], "/Masked/", subpopulations_names[s],"_tab19_pregnancy_masked.csv"))
datatable(tab17, options = list(scrollX=T))
}
```
