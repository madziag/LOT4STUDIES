...
# if previous NARC steps worked, these cases will already be sorted and removed
...
step_19.ALL<-c(step_8.ALL, step_19.balance)#i don't see this in the steps before
#fixed bug from =T to ==T(23 Aug 2021)
