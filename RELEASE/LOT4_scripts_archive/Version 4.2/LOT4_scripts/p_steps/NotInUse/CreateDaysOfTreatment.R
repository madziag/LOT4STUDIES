#Create Days of Treatment (temp)
#Author R Pajouheshnia
# 20 Jan 2021

#This script is a temporary script that only applies a fixed duration of 28 days to retinoids and valprotes.

# study_type <- "Retinoids"
# study_type <- "Valproates"
study_type <- "Both"

if(study_type == "Retinoids) load

med_list<-list.files(paste0(tmp,"medications/"), full.names = T,pattern="contracep")
