...
#Date = 23.03.22 
DAP = "PHARMO"
analysis = "alternative_medicine_bipolar" 
...
datao <- read.csv("PHARMO_ALL_alt_med_valp_bipolar_final_counts.csv")
...
ymin <- 0
ymax <- 20
y_lab <- "Rate of prescribing alternative bipolar medicines" 
