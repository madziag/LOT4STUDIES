...
datao <- read.csv("ARS_ALL_Valproate_discontinued_counts.csv")
...
model_final<-gls(yvar~time+level+trend,data = data_pi, correlation = corARMA(p=8,form =~time),method ="ML")
summary(model_final)
