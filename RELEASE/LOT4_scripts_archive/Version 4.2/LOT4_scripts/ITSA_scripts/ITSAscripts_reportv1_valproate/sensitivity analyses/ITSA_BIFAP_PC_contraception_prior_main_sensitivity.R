...
#Date = 23.03.22 
DAP = "BIFAP_PC"
analysis = "contraception_prior_main_sensitivity" 
...
datao <- read.csv("BIFAP_PC_Valproate_contraception_prior_counts_final_Pooled.csv")
datao<-datao[61:122,]
datao$time <- 1:62
...
ymin <- 0
ymax <- 30
y_lab <- "Percent prescriptions with prior contraceptive" 
