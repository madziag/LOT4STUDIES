...
# ##################################################################
# 
# #### MEDICINES FOLDER ONLY
# final_counts_rates_folders_strat <- list.files(path = medicines_stratified_dir, pattern = "ATC|indication|tx_duration|age_group")
# if(length(final_counts_rates_folders_strat)>0){
#   # Creates lists
#   count_names_all <- list()
#   count_files_all <- list()
#   # Extracts counts files
#   for (folder in 1:length(final_counts_rates_folders_strat)){
#     if(length(list.files(paste0(medicines_stratified_dir,"/", final_counts_rates_folders_strat[folder], "/"), pattern="count")) > 0){
#       count_names<-list.files(paste0(medicines_stratified_dir, "/",final_counts_rates_folders_strat[folder]), pattern = "count")
#       # Removes files that calculate proportions
#       count_names <- count_names[!grepl("discontinue",count_names)]
#       count_names <- count_names[!grepl("switch",count_names)]
#       count_files<-lapply(paste0(medicines_stratified_dir, "/",final_counts_rates_folders_strat[folder],"/", count_names), readRDS)
#       count_names_all[[folder]] <- count_names
#       count_files_all[[folder]] <- count_files
#     }
#   }
...
final_counts_props_folders_strat <- list.files(path = medicines_stratified_dir, pattern = "ATC|indication|tx_duration|age_group")
...
#### CONTRACEPTIVES FOLDER ONLY
# final_counts_rates_folders_strat_contra <- list.files(path = contraceptives_stratified_dir, pattern = "ATC|indication|tx_duration|age_group")
# if(length(final_counts_rates_folders_strat_contra)>0){
#   # Creates lists
#   count_names_all <- list()
#   count_files_all <- list()
#   # Extracts counts files
#   for (folder in 1:length(final_counts_rates_folders_strat_contra)){
#     if(length(list.files(paste0(contraceptives_stratified_dir,"/", final_counts_rates_folders_strat_contra[folder], "/"), pattern="count")) > 0){
#       count_names<-list.files(paste0(contraceptives_stratified_dir, "/",final_counts_rates_folders_strat_contra[folder]), pattern = "count")
#       count_files<-lapply(paste0(contraceptives_stratified_dir, "/",final_counts_rates_folders_strat_contra[folder],"/", count_names), readRDS)
#       count_names_all[[folder]] <- count_names
#       count_files_all[[folder]] <- count_files
#     }
#   }
