...
#Date = 23.03.22 
DAP = "BIFAP_PC"
analysis = "alternative_medicine_epilepsy" 
...
datao <- read.csv("BIFAP_PC_alt_med_valp_epilepsy_final_counts_Pooled.csv")
...
ymin <- 0
ymax <- 40
y_lab <- "Rate of prescribing alternative epilepsy medicines" 
