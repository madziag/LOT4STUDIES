...
datao <- read.csv("BIFAP_PC_Valproate_prevalence_counts_Pooled.csv")
...
ymin <- 0
ymax <- 4
y_lab <- "Number prevalent users per 1000 persons" 
...
#Plot results#
setwd("Y:/research-valproate-pooled/Report v1.0/Objective 1/ITSA_plots/main analyses")
