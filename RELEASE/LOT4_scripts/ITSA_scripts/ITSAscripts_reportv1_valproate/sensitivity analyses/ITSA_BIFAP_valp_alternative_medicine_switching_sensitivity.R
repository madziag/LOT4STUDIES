...
#Date = 23.03.22 
DAP = "BIFAP_PC"
analysis = "alternative_medicine_switching_sensitivity" 
...
datao <- read.csv("BIFAP_PC_Valproate_switched_to_alt_meds_counts_final_Pooled.csv")
datao<-datao[61:122,]
datao$time <- 1:62
...
#Plot results#
setwd("Y:/research-valproate-pooled/Report v1.0/Objective 4/ITSA_plots/sensitivity analyses")
